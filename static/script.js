...
var utils = function () {
  ...
  _createClass(utils, [{
    ...
    key: 'isPixelCollision',
    value: function isPixelCollision(first, x, y, other, x2, y2, isCentered) {
...
var _particleCanvas = __webpack_require__(9);
...
var App = function () {
  ...
  function App() {
    ...
    /** DOM References */
    this.$preloader = (0, _utils.$)('.preloader')[0];
  ...
  _createClass(App, [{
    ...
    value: function _initUI() {
      ...
      var logo = this.$preloader.querySelectorAll('.preloader__logo')[0];

      this.utils.delay(function () {
        logo.classList.remove('fade-in-up');
        logo.classList.add('fade-out-up');
      }, 1000).delay(function () {
        _this.$preloader.classList.add('fade-out');
...
var _particle = __webpack_require__(10);
...
var ParticleCanvas = function () {
  function ParticleCanvas() {
    ...
    this.mouseBall = new _particle2.default(50, 'transparent');
    ...
    */
    ...
    value: function _generateParticles() {
      for (var i = 0; i < this.numOfParticles; i++) {
        var particle = new _particle2.default(this.utils.randInt(1, 4), this.particleColors[this.utils.randInt(0, this.particleColors.length)]);
