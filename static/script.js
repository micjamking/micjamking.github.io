...
var Parallaxer = function () {
   ...
   * @constructor
   */
  function Parallaxer(rootElement, rotationSensitivity, translateSensitity) {
    ...
    this.mousePosition_ = this.utils.captureMouse(_utils.w);
  }
...
var StateService = function () {
  ...
  _createClass(StateService, [{
    key: '_getLocationPath',
    value: function _getLocationPath() {
    ...
    key: '_setLocationPath',
    value: function _setLocationPath(pathname) {
    ...
    value: function setCurrentLocation(pathname) {
